...
import jungle68.com.library.beans.Line;
...
public class MusicLineView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mLines.size(); i++) {
            ...
            canvas.drawLine(line.getStartX(), mStartYLevels[(int) Math.round((Math.random() * (mMaxLevel - 1)))], line.getEndX(), line.getEndY(), mPaint);
        }
    }
